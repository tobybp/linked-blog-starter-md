...
![[Excalidraw/capacitordiagram.md|600]]
...
The capacitance of a capacitor is defined as: "the magnitude of the charge stored on one plate per unit of p.d. between the plates"
![[Excalidraw/capacitance2.md|500]]
C = Q/V
Units:
	\[Q] = coulombs, C
	\[V] = volts, V
